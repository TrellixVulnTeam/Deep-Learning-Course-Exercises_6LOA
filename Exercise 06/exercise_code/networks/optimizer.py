...
Inputs:
  ...
  - config: A dictionary containing hyper-parameter values such as 
...
well; however the default values of the other hyper-parameters should work well
...
class SGD(object):
    ...
    def backward(self, y_predictions, y_true):
        ...
        """
        d_out = self.loss_func.backward(y_predictions, y_true)
